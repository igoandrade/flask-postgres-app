...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL').replace("://", "ql://", 1) #"postgres://ortqzqbrwzfcuo:bcc47786fd9f93af8079abd1434cb3860bf3974448de4e8855d7f72b920838e6@ec2-44-193-178-122.compute-1.amazonaws.com:5432/d8uocf3jcl9rd0"#"postgresql://postgres:12345@localhost:5432/cars_api"
